...
export default function Home() {
  ...
  return (
    <div className="pt-[20px] md:pt-[60px]">
      <Hero />
      <div className="max-w-screen-xl mx-auto px-5 lg:px-10 2xl:px-0 py-10 lg:py-20">
        <MovingImage />
      </div>
      <div className="max-w-screen-xl mx-auto px-5 lg:px-10 2xl:px-0 py-10 lg:py-20">
        <section className="section panal section_2 overflow-hidden">
          <div className="section_2_main grid grid-cols-1 md:grid-cols-2 text-white">
            <div className="section_2_left hidden !h-screen md:flex flex-col justify-center items-center">
              <div className="anime_titile hover_layer-md md:text-[18px] lg:text-[27px] absolute top-[16%]">
                <span>We Print Your Vision into Reality</span>
              </div>
            ...
            <div className="section_2_right">
              <div className="sec_2_right_details m-auto w-[80%]">
                ...
                <div className="h-full md:h-screen mt-12 md:mt-0 mb-24 md:mb-0 flex justify-center items-center">
                  <div className="details flex flex-col justify-center h-auto hover_layer">
                    <div className="headline text-[20px] md:text-[32px] lg:text-[42px] mb-4 font-bold ">
                      <span>
                        The Imprint Advantage of Melding Art and Technology
                      </span>
                    </div>
                    <div className="text text-[14px] md:text-[16px] lg:text-[20px]">
                      Imprint Printing Press is not just any ordinary printing
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 pt-20">
            <div className="p-7 bg-[#1A1A1A] rounded-[10px] flex flex-col lg:flex-row justify-center gap-5 items-start">
              ...
              <div className="flex flex-col gap-5">
                ...
                <p className="text-white text-xs lg:text-sm opacity-[0.6]">
                  We handle a wide range of printing projects with expertise.
                  Our team bring imagination to life through paper.
                </p>
              </div>
            </div>
            <div className="p-7 bg-[#1A1A1A] rounded-[10px] flex flex-col lg:flex-row justify-center gap-5 items-start">
              ...
              <div className="flex flex-col gap-5">
                ...
                <p className="text-white text-xs lg:text-sm opacity-[0.6]">
                  We deliver products on time to ensure customer satisfaction
                  efficiently. Our motto lies in time-bound and on-date
                  completion of printing projects.
                </p>
              </div>
            </div>
            <div className="p-7 bg-[#1A1A1A] rounded-[10px] flex flex-col lg:flex-row justify-center gap-5 items-start">
              ...
              <div className="flex flex-col gap-5">
                ...
                <p className="text-white text-xs lg:text-sm opacity-[0.6]">
                  Our printing press is characterised by exemplary
                  craftsmanship, promising accurate attention to detail. We
                  stand for precision in our work. 
                </p>
              </div>
            </div>
            <div className="p-7 bg-[#1A1A1A] rounded-[10px] flex flex-col lg:flex-row justify-center gap-5 items-start">
              ...
              <div className="flex flex-col gap-5">
                ...
                <p className="text-white text-xs lg:text-sm opacity-[0.6]">
                  Experience top-tier customisation in printing. We stand
                  alongside you to match your unique requirements and
                  preferences.
                </p>
              </div>
            </div>
            <div className="p-7 bg-[#1A1A1A] rounded-[10px] flex flex-col lg:flex-row justify-center gap-5 items-start">
              ...
              <div className="flex flex-col gap-5">
                ...
                <p className="text-white text-xs lg:text-sm opacity-[0.6]">
                  Our printing press prioritises customer needs, offering swift
                  assistance and maintaining exceptional service standards.
                </p>
              </div>
            </div>
            <div className="p-7 bg-[#1A1A1A] rounded-[10px] flex flex-col lg:flex-row justify-center gap-5 items-start">
              ...
              <div className="flex flex-col gap-5">
                ...
                <p className="text-white text-xs lg:text-sm opacity-[0.6]">
                  Our dedicated team never compromise on product quality,
                  because we believe quality is the soul of success.
                </p>
              </div>
            </div>
          </div>
