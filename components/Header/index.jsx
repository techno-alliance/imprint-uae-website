...
export default function index() {
    ...
    useEffect(() => {
        // Function to close nav menu on scroll
        const handleScroll = () => {
            if (isActive) {
                setIsActive(false);
            }
                ...
                <div className={styles.bar}>
                    ...
                    <div onClick={() => {setIsActive(!isActive)}} className={styles.el}>
                        ...
                        <div className={styles.label}>
                            <motion.p variants={opacity} animate={!isActive ? "open" : "closed"} className='text-base md:text-xl'>Menu</motion.p>
                            <motion.p variants={opacity} animate={isActive ? "open" : "closed"} className='text-base md:text-xl'>Close</motion.p>
                        </div>
                    </div>
