      ...
      <div className="bg-black">
        <div className="">
          <div className="flex flex-col justify-center items-center lg:items-start gap-3">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-5 lg:gap-10 w-full">
              ...
              <div className="flex justify-center items-center w-auto lg:w-[360px]">
      ...
      >
        ...
        <SwiperSlide className="!p-3 lg:!p-0 !bg-black">
          <div className="!flex !flex-col lg:!flex-row !justify-between gap-5 lg:gap-0 rounded-[10px] !p-3 !w-full !h-full lg:!w-[700px] lg:!h-[300px] !overflow-hidden !relative group !bg-[#1E1E1E]">
            <div className="flex flex-col gap-5 lg:gap-0 justify-between w-full h-full z-10">
            ...
            <div className="absolute left-[0%] bottom-[-3%] hidden lg:block">
              <Image className="w-full h-full object-center object-cover" src={Ellipse}/>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide className="!p-3 lg:!p-0 !bg-black">
